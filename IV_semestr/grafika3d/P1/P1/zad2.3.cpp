...
"   vec3 offsetPos = vec3(flippedPos.x + xOffset, flippedPos.y, flippedPos.z);\n"
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Triangle Position as Color", NULL, NULL);
    if (window == NULL)
    {
