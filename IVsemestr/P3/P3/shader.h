...
public:
    unsigned int ID;
    // Konstruktor generujacy od razu shadery
    Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath = nullptr)
    {
        ...
        // konfiguracja przerwañ ifstream
        ...
        try
        {
            ...
            // ewentualne zaladowanie geometry shader - jezeli podana zostala sciezka
        ...
        // ewentualna kompilacja geometry
