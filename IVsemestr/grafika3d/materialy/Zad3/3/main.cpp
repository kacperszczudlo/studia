...
#include "C:\Users\Kacper\Desktop\Byrski\stb_image.h"
#include "../../shader.h"
...
int main(int argc, char* argv[])
{
    ...
    // ustawienie mapowania tekstury 1
    ...
    unsigned char* data = stbi_load("C:\\Users\\Kacper\\Desktop\\Byrski\\1.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    data = stbi_load("C:\\Users\\Kacper\\Desktop\\Byrski\\2.png", &width, &height, &nrChannels, 0);
    if (data)
    {
