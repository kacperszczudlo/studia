           ...
           <div>
               <div style={{display: 'flex', justifyContent: 'space-between'}}>
                   <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                       ...
                       <li className="nav-item" role="presentation">
                           <Link to="/about" className="nav-link" id="pills-home-tab" data-toggle="pill" role="tab"
                                 aria-controls="pills-home" aria-selected="true">About</Link>
                       </li>
                       <li className="nav-item" role="presentation">
                           <Link to="/contact" className="nav-link" id="pills-home-tab" data-toggle="pill" role="tab"
                                 aria-controls="pills-home" aria-selected="true">Contact</Link>
                       </li>
                       <li className="nav-item" role="presentation">
                           <Link to="/services" className="nav-link" id="pills-home-tab" data-toggle="pill" role="tab"
                                 aria-controls="pills-home" aria-selected="true">Servieces</Link>
                       </li>
                   </ul>
                   <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                       {isNotLogged && <li className="nav-item" role="presentation">
                           <Link to="/loginForm" className="nav-link" id="pills-home-tab" data-toggle="pill" role="tab"
